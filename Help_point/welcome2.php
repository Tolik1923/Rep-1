...
<body>
    ...
    $sql = "SELECT * FROM kyr.time WHERE Flight_number = '$n' and Date = '$d'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        echo "<table><tr><th>Flight_number</th><th>Date</th><th>Departure_time</th><th>Travel_time</th><th>Arrival_time</th></tr>";
    ...
    <h3>About boarding</h3>
    Terminal: <input type="text" name="ter"><br>
    Departure_time: <input type="text" name="time"><br>
